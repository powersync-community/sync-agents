...
This folder contains assets that are bundled with the Electron app and synced to the user's `{CONFIG_DIR}/` directory on every launch.
...
|-------------|-----------|---------------|
| `docs/` | `{CONFIG_DIR}/docs/` | Always overwrite on launch |
| `themes/` | `{CONFIG_DIR}/themes/` | Always overwrite on launch |
| `permissions/` | `{CONFIG_DIR}/permissions/` | Always overwrite on launch |
| `tool-icons/` | `{CONFIG_DIR}/tool-icons/` | Always overwrite on launch |
| `config-defaults.json` | `{CONFIG_DIR}/config-defaults.json` | Always overwrite on launch |
