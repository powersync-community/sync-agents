    ...
    <div className="h-full flex flex-col">
      ...
      <div className="flex-1 min-h-0 mask-fade-y">
        <ScrollArea className="h-full">
          ...
          <SettingsSection
            title="Basic Info"
            description="Help Sync Agent personalize responses to you."
          >
            <SettingsCard divided>
              <SettingsInput
                label="Name"
                description="How Sync Agent should address you."
              ...
              <SettingsInput
                label="Language"
                description="Preferred language for Sync Agent's responses."
          ...
          <SettingsSection
            title="Notes"
            description="Free-form context that helps Sync Agent understand your preferences."
            action={
          ...
          >
            <SettingsCard divided={false}>
              <SettingsTextarea
                ...
                placeholder="Any additional context you'd like Sync Agent to know..."
                rows={5}
                inCard
              />
            </SettingsCard>
