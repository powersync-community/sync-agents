 ...
 *
 * File locations:
 * - Workspace: {CONFIG_DIR}/workspaces/{slug}/permissions.json
 * - Per-source: {CONFIG_DIR}/workspaces/{slug}/sources/{sourceSlug}/permissions.json
 *
...
/**
 * Load default permissions from {CONFIG_DIR}/permissions/default.json
...
class PermissionsConfigCache {
  ...
  // App-level default permissions (loaded from {CONFIG_DIR}/permissions/default.json)
   ...
   * These come from {CONFIG_DIR}/permissions/default.json
   */
