...
export function ensureConfigDir(): void {
  ...
  // Initialize bundled docs (creates {CONFIG_DIR}/docs/ with sources.md, agents.md, permissions.md)
  initializeDocs();
...
export function addWorkspace(workspace: Omit<Workspace, 'id' | 'createdAt'>): Workspace {
  ...
  if (existing) {
    ...
    const updated: Workspace = {
      ...existing,
      ...workspace,
      storageMode: workspace.storageMode ?? existing.storageMode ?? 'local',
      id: existing.id,
  ...
  const newWorkspace: Workspace = {
    ...workspace,
    storageMode: workspace.storageMode ?? 'local',
...
/**
 * Get the path to the app-level theme override file ({CONFIG_DIR}/theme.json).
 */
 ...
 * Preset themes are stored at {CONFIG_DIR}/themes/
 */
...
/**
 * Returns the path to the tool-icons directory: {CONFIG_DIR}/tool-icons/
 */
