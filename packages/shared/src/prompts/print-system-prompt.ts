#!/usr/bin/env bun
/**
 * Debug script to print the full Sync Agent system prompt with annotations.
...
printAnnotation('  2. Sync Agent environment marker - version, platform, arch');
...
${colors.bold}SDK Configuration:${colors.reset}
  ...
  systemPrompt.append: getSystemPrompt() ${colors.dim}// Sync Agent additions (static, cacheable)${colors.reset}
...
${colors.bold}Static System Prompt Components:${colors.reset}
  ...
  2. Sync Agent environment marker      ${colors.dim}// Version, platform, arch${colors.reset}
