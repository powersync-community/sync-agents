 ...
 *
 * The mapping lives in {CONFIG_DIR}/tool-icons/tool-icons.json alongside the
 ...
 *
 * @param toolIconsDir - Path to the tool-icons directory (e.g. {CONFIG_DIR}/tool-icons/)
 ...
 *
 * @param commandStr - Full bash command string, e.g. "git add . && npm publish"
 * @param toolIconsDir - Path to {CONFIG_DIR}/tool-icons/ containing tool-icons.json and icon files
