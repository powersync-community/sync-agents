 ...
 * Default location: {CONFIG_DIR}/workspaces/
 */
...
/**
 * Get the default workspaces directory ({CONFIG_DIR}/workspaces/)
 */
 ...
 * @param baseDir - Parent directory where workspace folders live (e.g., {CONFIG_DIR}/workspaces/)
 ...
 * Returns paths to valid workspaces found in {CONFIG_DIR}/workspaces/
 */
